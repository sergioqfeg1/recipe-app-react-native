...
import YoutbeIframe from 'react-native-youtube-iframe'
...
const RecipeDetailScreen = () => {
  ...
  useEffect(() => {
    ...
    const loadRecipeDetail = async () => {
        ...
        try {
            ...
            if (mealData) {
                const mappedRecipe = MealAPI.mapMealData(mealData)
  ...
  const getYoutubeEmbedUrl = (url) => {
    ...
    // return `https://www.youtube.com/embed/${videoId}?fs=1&modestbranding=1&rel=0`
  }
    ...
    <View style={recipeDetailStyles.container}>
      <ScrollView>
        ...
        <View style={recipeDetailStyles.headerContainer}>
            ...
            {/* Se ve incorrecto porque se camuflará con los detalles */}
            <LinearGradient 
            ...
            {recipe.youtubeUrl && (
                <View style={recipeDetailStyles.sectionContainer}>
                    ...
                    <View style={recipeDetailStyles.videoCard}>
                        ...
                        /> */}
                        <YoutbeIframe
                            videoId={getYoutubeEmbedUrl(recipe.youtubeUrl)}
                            play={false}
                            height="100%"
                            width="100%"
                        />
